...
for i in range (corridas):
	...
	txt = open(f"Rendimiento_inv_{i+1}_matriz_dispersa.txt", "r")
...
xlt = [10, 20, 50, 100, 200, 500, 1000, 5000, 1000, 2000, 10000, 20000]				
yvt = [0.0001, 0.001, 0.01, 0.1, 1, 10, 60]									

ylt = ["0.1 ms", "1 ms", "10 ms", "0.1 s", "1 s", "10 s", "1 min"]		

plt.title("Rendimiento INV Matriz Dispersa")
...
xlm = [10, 20, 50, 100, 200, 500, 1000, 5000, 1000, 2000, 10000, 20000]						
yvm = [0.00001, 0.0001, 0.001, 0.01, 0.1, 1, 10, 60]									

ylm = ["0.01 ms","0.1 ms", "1 ms", "10 ms", "0.1 s", "1 s", "10 s", "1 min"]		
